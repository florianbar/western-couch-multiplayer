...
// First 2 vertices
draw_vertex_texture_colour(_x+lengthdir_x(_scale_product, _dir+90), _y+lengthdir_y(_scale_product, _dir+90), t_texture_offset, 0, c_white, 1);
draw_vertex_texture_colour(_x+lengthdir_x(_scale_product, _dir-90), _y+lengthdir_y(_scale_product, _dir-90), t_texture_offset, 1, c_white, 1);
...
repeat(t_size_current-1) //for(var i = 1; i < t_size_current; i++)
{
	...
	// Draw the segment
	draw_vertex_texture_colour(_x2+lengthdir_x(_scale_product, _dir+90), _y2+lengthdir_y(_scale_product, _dir+90), t_texture_offset + _dist, 0, c_white, 1);
	draw_vertex_texture_colour(_x2+lengthdir_x(_scale_product, _dir-90), _y2+lengthdir_y(_scale_product, _dir-90), t_texture_offset + _dist, 1, c_white, 1);
...
draw_vertex_texture_colour(t_x+lengthdir_x(_scale_product, t_dir+90), t_y+lengthdir_y(_scale_product, t_dir+90), t_texture_offset + _dist, 0, c_white, 1);
draw_vertex_texture_colour(t_x+lengthdir_x(_scale_product, t_dir-90), t_y+lengthdir_y(_scale_product, t_dir-90), t_texture_offset + _dist, 1, c_white, 1);
